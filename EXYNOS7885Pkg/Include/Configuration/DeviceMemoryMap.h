...
//--------------------- DDR --------------------- */
  {"TrustZone 0",       0x800000000, 0x000600000, AddDev, MMAP_IO, UNCACHEABLE, MmIO,   NS_DEVICE},
  {"UEFI Stack",        0x800600000, 0x000040000, AddMem, MEM_RES, UNCACHEABLE, RtCode, NS_DEVICE},
  ...
  {"Display Reserved",  0x83EE00000, 0x0002C6000, AddMem, MEM_RES, SYS_MEM_CAP, Reserv, WRITE_THROUGH_XN},
//{"HLOS 3",            0x83DE00000, 0x001900000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK},
  {"TrustZone 1",       0x83F700000, 0x000100000, AddDev, MMAP_IO, UNCACHEABLE, MmIO,   NS_DEVICE},
