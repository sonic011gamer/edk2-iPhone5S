...
//--------------------- DDR --------------------- */
  {"TrustZone 0",       0x800000000, 0x000600000, AddDev, SYS_MEM, SYS_MEM_CAP, Reserv, NS_DEVICE},
  {"UEFI Stack",        0x800600000, 0x000040000, AddMem, SYS_MEM, SYS_MEM_CAP, BsData, WRITE_BACK},
  {"CPU Vectors",       0x800640000, 0x000010000, AddMem, SYS_MEM, SYS_MEM_CAP, BsCode, WRITE_BACK},
  {"UEFI FD",           0x800650000, 0x000200000, AddMem, SYS_MEM, SYS_MEM_CAP, BsCode, WRITE_BACK},
  {"HLOS 2",            0x800850000, 0x03E5B0000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK},
  {"Display Reserved",  0x83EE00000, 0x0002C6000, AddMem, MEM_RES, SYS_MEM_CAP, Reserv, WRITE_THROUGH},
  {"HLOS 3",            0x83F0C6000, 0x00063A000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK},
  {"TrustZone 1",       0x83F700000, 0x000100000, AddDev, SYS_MEM, SYS_MEM_CAP, Reserv, NS_DEVICE},
  {"ASP",               0x83f800000, 0x000800000, AddDev, SYS_MEM, SYS_MEM_CAP, Reserv, NS_DEVICE},
